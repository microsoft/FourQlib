...
// FourQ's element and point definitions using a redundant representation 

#define VWORDS_FIELD 5                                     // Number of 32-bit words representing a field element

typedef uint32_t velm_t[VWORDS_FIELD];                     // Datatype for representing 128-bit field elements 
typedef uint32_t v2elm_t[2*VWORDS_FIELD];                  // Datatype for representing quadratic extension field elements 
